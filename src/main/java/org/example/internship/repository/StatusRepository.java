...
@Repository
public interface StatusRepository extends PagingAndSortingRepository<StatusEntity, Long>, JpaSpecificationExecutor<StatusEntity>, JpaRepository<StatusEntity, Long> {
